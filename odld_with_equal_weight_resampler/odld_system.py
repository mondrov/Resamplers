...
bintargetcount = 6  # number of walkers per bin
nbins = [103]  # You will have prod(binsperdim)+numberofdim*(2*splitIsolated) bins total
...
class ODLDPropagator(WESTPropagator):
    def __init__(self, rc=None):
        ...
        self.sigma = .01 ** (0.5)  # friction coefficient
